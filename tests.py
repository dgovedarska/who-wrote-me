...
class StylometryTest(unittest.TestCase):
    ...
    def test_text_features(self):
        ...
        self.assertEqual(r, {'lexical diversity': 1,
                'average sentence length': 10,
                'most common word length': 3,
                'unusual words content fraction': 10})

    def test_text_features_wrong_file(self):
        self.assertRaises(IOError, stylometry.Text_Analysis().text_features("./"))
